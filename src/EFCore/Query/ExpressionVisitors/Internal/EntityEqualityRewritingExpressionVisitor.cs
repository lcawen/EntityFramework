    ...
    public class EntityEqualityRewritingExpressionVisitor : ExpressionVisitorBase
    {
        ...
        protected override Expression VisitBinary(BinaryExpression binaryExpression)
        {
                ...
                || binaryExpression.NodeType == ExpressionType.NotEqual)
            {
                ...
                var leftProperties = MemberAccessBindingExpressionVisitor.GetPropertyPath(
                    newBinaryExpression.Left, _queryCompilationContext, out leftNavigationQsre);

                var rightProperties = MemberAccessBindingExpressionVisitor.GetPropertyPath(
                    newBinaryExpression.Right, _queryCompilationContext, out rightNavigationQsre);
        ...
        protected override Expression VisitMethodCall(MethodCallExpression methodCallExpression)
        {
                ...
                && newRightExpression != null)
            {
                ...
                var leftProperties = MemberAccessBindingExpressionVisitor.GetPropertyPath(
                    newLeftExpression, _queryCompilationContext, out leftNavigationQsre);

                var rightProperties = MemberAccessBindingExpressionVisitor.GetPropertyPath(
                    newRightExpression, _queryCompilationContext, out rightNavigationQsre);
